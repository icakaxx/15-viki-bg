...
export default async function handler(req, res) {
  ...
  try {
    ...
    const productData = {
      ...
      cop: cop || null,
      scop: scop || null,
      power_consumption_cooling: power_consumption_cooling || null,
      power_consumption_heating: power_consumption_heating || null,
      cooling_power_kw: cooling_power_kw || null,
      heating_power_kw: heating_power_kw || null,
